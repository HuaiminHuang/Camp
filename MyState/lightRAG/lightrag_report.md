...
```bash
# 工作目录配置（知识图谱存储位置）
WORKING_DIR=/home/h2mzzz/light_RAG/LightRAG/dickens
...
1. **编辑.env文件**：
   ```bash
   WORKING_DIR=/path/to/your/new/directory
   ```
2. **目录内容要求**：
   - **新目录**：自动创建，需重新插入文档构建知识图谱
   - **已有数据**：包含LightRAG生成的文件即可直接加载
...
- **API文档**：`http://localhost:9621/docs`
...
![](images/13_0.jpg)
*图5：关键词提取提示模板（来源：论文图6）*

![](images/13_1.jpg)
*图6：RAG评估提示模板（来源：论文图7）*
